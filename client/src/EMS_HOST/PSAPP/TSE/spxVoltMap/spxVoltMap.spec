...
datas = [('load_line.gif', '.'), ('land.geojson', '.'), ('optimized.geojson', '.'), ('jeju.geojson', '.'), ('shp.geojson', '.'), ('voltmap_local.csv', '.'), ('assets', 'assets'), ('C:\\Program Files\\Python39\\Lib\\site-packages\\zstandard', 'zstandard'), ('C:\\Program Files\\Python39\\Lib\\site-packages\\zstandard-0.21.0.dist-info', 'zstandard-0.21.0.dist-info'), ('C:\\Program Files\\Python39\\Lib\\site-packages\\numpy', 'numpy'), ('C:\\Program Files\\Python39\\Lib\\site-packages\\numpy\\.libs', 'numpy/.libs'), ('C:\\Program Files\\Python39\\Lib\\site-packages\\scipy', 'scipy')]
binaries = []
...
tmp_ret = collect_all('spxVoltMap.py')
